...
# Habilidades que serão testadas
...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-013-a-project-playground-functions.git`
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-013-a-project-playground-functions`
...
6. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-013-a-project-playground-functions/pulls)
